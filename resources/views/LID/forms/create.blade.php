    ...
    <form action="{{ route('lid.reservations.store') }}" method="POST" id="chemicalRequestForm">
        ...
        <div class="phase" id="phase3" style="display: none;">
            ...
            <div class="alert alert-info">
                <i class="bi bi-info-circle-fill"></i> <strong>Note:</strong> Total quantity will be calculated automatically based on number of groups.
            </div>
        ...
        <div class="phase" id="phase4" style="display: none;">
            ...
            <div class="alert alert-warning">
                <i class="bi bi-exclamation-triangle-fill"></i> <strong>Important:</strong> These chemicals are regulated by PDEA. Please ensure all information is accurate and complete.
            </div>
        ...
        <div class="phase" id="phase6" style="display: none;">
            ...
            <div class="alert alert-warning">
                <i class="bi bi-exclamation-triangle-fill"></i> <strong>Important:</strong> These items may require special handling or training. Please ensure all information is accurate.
            </div>
