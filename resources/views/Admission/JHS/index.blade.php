...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
        <h1 class="mt-4 fw-bold">Junior High School Admission</h1>
        <a href="{{ route('admission.jhs.create') }}" class="btn btn-custom">
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card custom-card card-5 h-100">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between">
                    <a class="small text-dark stretched-link" href="{{ route('admission.jhs.totalapplicants') }}">View Details</a>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card custom-card card-2 h-100">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between">
                    <a class="small text-dark stretched-link" href="{{ route('admission.jhs.totalenrolled') }}">View Details</a>
                    <div class="small text-dark"><i class="bi-arrow-right"></i></div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card custom-card card-4 h-100">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between">
                    <a class="small text-dark stretched-link" href="{{ route('admission.jhs.unsched') }}">View Details</a>
                    <div class="small text-dark"><i class="bi-arrow-right"></i></div>
                </div>
            </div>
        </div>
    ...
    <!-- Search Bar -->
    <form method="GET" action="{{ route('admission.jhs.index') }}" class="d-flex mb-3">
    ...
    <!-- Per page control -->
    <form method="GET" action="{{ route('admission.jhs.index') }}" class="mb-3">
