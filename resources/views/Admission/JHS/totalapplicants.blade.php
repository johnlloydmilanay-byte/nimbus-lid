...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
        <h1 class="mt-4 fw-bold">JHS Admission | Total Applicants</h1>
                    ...
                    <td class="text-center">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item" href="{{ route('admission.jhs.edit', $app->application_number) }}">
                                        <i class="bi-pencil-square me-2"></i> Update
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ route('admission.jhs.view_print', $app->application_number) }}">
    ...
    <!-- Per page control -->
    <form method="GET" action="{{ route('admission.jhs.totalapplicants') }}" class="mb-3">
