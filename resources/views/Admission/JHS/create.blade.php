    ...
    <form action="{{ route('admission.jhs.store') }}" method="POST">
        ...
        <div class="row g-3 mt-1 mb-4">
            ...
            <div class="col-12 col-md-6">
                ...
                <input type="text" class="form-control" name="lrn" placeholder="Enter School LRN" required>
            </div>
        </div>
        <div class="row g-3 mt-1 mb-4">
            <div class="col-12 col-md-9">
        ...
        <div class="row g-3 mb-4">
            <div class="col-12">
                <label class="form-label">JHS Program: <span class="text-danger">*</span></label>
                <select class="form-select" name="program" required>
                    @foreach($programs as $key => $strand)
                        <option value="{{ $strand->id }}" {{ $key === 0 ? 'selected' : '' }}>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function searchStudents(query) {
            fetch(`{{ route('admission.jhs.search-students') }}?query=${encodeURIComponent(query)}`)
        ...
        function selectStudent(studentId) {
            fetch(`{{ route('admission.jhs.student-details', '') }}/${studentId}`)
                .then(response => response.json())
                .then(student => {
        ...
        document.getElementById('jhsForm').addEventListener('submit', function(e) {
