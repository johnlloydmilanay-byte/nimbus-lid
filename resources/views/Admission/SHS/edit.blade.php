...
<div class="container-fluid px-4">
    ...
    <form action="{{ route('admission.shs.update', $application->application_number) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-12">
                ...
                <select class="form-select" name="choice_second" required>
                    @foreach($programs as $strand)
                        <option value="{{ $strand->id }}"
                            {{ old('choice_second', $application->choice_second) == $strand->id ? 'selected' : '' }}>
                            {{ $strand->code }} - {{ $strand->name }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="row g-3 mt-1">
            <div class="col-12 col-md-3">
                ...
                <select class="form-select" name="applicant_status" required>
                    <option value="Incoming Grade 11" {{ old('applicant_status', $application->applicant_status ?? '') == 'Incoming Grade 11' ? 'selected' : '' }}>Incoming Grade 11</option>
                    <option value="Transferee" {{ old('applicant_status', $application->applicant_status ?? '') == 'Transferee' ? 'selected' : '' }}>Transferee</option>
                    </select>
            </div>
            <div class="col-12 col-md-3">
