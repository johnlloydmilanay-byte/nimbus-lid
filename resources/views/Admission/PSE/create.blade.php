    ...
    <form action="{{ route('admission.pse.store') }}" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-12 col-md-6">
                ...
                <input type="text" class="form-control" name="lrn" placeholder="Enter LRN">
            </div>
        </div>
        <div class="row g-3 mt-1 mb-4">
            <div class="col-12 col-md-9">
                <label class="form-label">School Address:</label>
                <input type="text" class="form-control" name="school_address" placeholder="Enter School Address">
            </div>
            <div class="col-12 col-md-3">
                <label class="form-label">Zip Code:</label>
                <input type="text" class="form-control" name="school_zip" placeholder="Enter Zip Code">
            </div>
        </div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-12">
                ...
                <select class="form-select" name="program" required>
                    <option value="" disabled selected>Choose PSE Program</option>
                    <option>PRESCHOOL : Nursery</option>
                    <option>PRESCHOOL : Preparatory</option>
                    <option>PRESCHOOL : Kinder</option>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function searchStudents(query) {
            fetch(`{{ route('admission.pse.search-students') }}?query=${encodeURIComponent(query)}`)
        ...
        function selectStudent(studentId) {
            fetch(`{{ route('admission.pse.student-details', '') }}/${studentId}`)
                .then(response => response.json())
                .then(student => {
        ...
        document.getElementById('pseForm').addEventListener('submit', function(e) {
